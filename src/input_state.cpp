...
bool InputState::isKeyDown(Key key) const noexcept
{
    return state_->isKeyDown(key);
}

bool InputState::isKeyPressed(Key key) const noexcept
{
    return state_->isKeyPressed(key);
}

bool InputState::isKeyReleased(Key key) const noexcept
{
...
std::pair<double, double> InputState::mousePosition() const noexcept
{
    return state_->mousePosition();
}

std::pair<double, double> InputState::mouseDelta() const noexcept
{
    return state_->mouseDelta();
}

std::pair<double, double> InputState::scrollDelta() const noexcept
{
    return state_->scrollDelta();
}

bool InputState::isMouseInside() const noexcept
{
